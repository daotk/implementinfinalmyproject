    ...
    public partial class frm_City : Form
    {
        ...
        private void btn_Luu_Click(object sender, EventArgs e)
        {
            if (flag_them == true)
            {
                ...
                {
                    MessageBox.Show("Tỉnh – Thành phố đã được tạo thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            if (flag_sua == true)
            {
                ...
                if (txt_TenTinhThanh.Text == null || txt_TenTinhThanh.Text == "")
                {
                    MessageBox.Show("Bạn chưa nhập tên tỉnh thành", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                {
                    MessageBox.Show("Tỉnh – Thành phố đã được chỉnh sửa thành công", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            loadDatagrid();
            lbl_chedo.Text = "";
